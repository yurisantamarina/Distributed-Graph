			...
			try {
				...
				while (opcaoInicial != Acao.FINALIZAR) {
					try {
						...
						System.out.println("12 - Listar arestas de um vertice");
						System.out.println("13 - Listar vertices vizinhos de um vertice");
						System.out.println("14 - Caminho minimo");
						...
						case Acao.CAMINHO_MINIMO:
							...
							double ans = client.caminhoMinimo(nomeVertice1, nomeVertice2);
							if(ans > 10000000) result = "Não existe caminho entre " + nomeVertice1 + " e " + nomeVertice2 + "\n";
							else result = "Caminho minimo entre " + nomeVertice1 + " e " + nomeVertice2 + " = " + ans + "\n";
