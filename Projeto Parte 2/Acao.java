...
public interface Acao {
	...
	public static int LISTAR_VERTICES_DE_UMA_ARESTA	= 11;
	public static int LISTAR_ARESTAS_DE_UM_VERTICE 	= 12;
	public static int LISTAR_VERTICES_VIZINHOS		= 13;
	public static int CAMINHO_MINIMO				= 14;
